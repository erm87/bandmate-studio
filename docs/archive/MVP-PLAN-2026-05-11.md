> **Archival note (2026-05-14):** This is a historical record of the
> phased v0.1 plan as written at project scaffolding on 2026-05-11.
> Most items have shipped or been refactored; current release-level
> planning lives in [docs/ROADMAP.md](../ROADMAP.md) and active
> polish items in [BACKLOG.md](../../BACKLOG.md). The git log
> preserves this file's history at its original path (`MVP-PLAN.md`
> at the repo root).
